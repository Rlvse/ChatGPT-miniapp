...
!function() {
    function e(t) {
        this.mode = a.MODE_8BIT_BYTE, this.data = t, this.parsedData = [];
    ...
    e.prototype = {
        ...
        setupTypeNumber: function(t) {
            for (var e = u.getBCHTypeNumber(this.typeNumber), r = 0; r < 18; r++) o = !t && 1 == (e >> r & 1), 
        ...
        setupTypeInfo: function(t, e) {
            for (var r = this.errorCorrectLevel << 3 | e, o = u.getBCHTypeInfo(r), n = 0; n < 15; n++) i = !t && 1 == (o >> n & 1), 
        ...
        mapData: function(t, e) {
            for (var r = -1, o = this.moduleCount - 1, n = 7, i = 0, a = this.moduleCount - 1; a > 0; a -= 2) for (6 == a && a--; ;) {
                for (var s = 0; s < 2; s++) if (null == this.modules[o][a - s]) {
                    var h = !1;
                    i < t.length && (h = 1 == (t[i] >>> n & 1)), u.getMask(e, o, a - s) && (h = !h), 
        ...
        for (var a = n.getRSBlocks(t, e), s = new i(), h = 0; h < o.length; h++) {
            var l = o[h];
            s.put(l.mode, 4), s.put(l.getLength(), u.getLengthInBits(l.mode, t)), l.write(s);
        }
        var g = 0;
        for (h = 0; h < a.length; h++) g += a[h].dataCount;
        ...
        for (;!(s.getLengthInBits() >= 8 * g || (s.put(r.PAD0, 8), s.getLengthInBits() >= 8 * g)); ) s.put(r.PAD1, 8);
        return r.createBytes(s, a);
    }, r.createBytes = function(t, e) {
        for (var r = 0, n = 0, i = 0, a = new Array(e.length), s = new Array(e.length), h = 0; h < e.length; h++) {
            var l = e[h].dataCount, g = e[h].totalCount - l;
            for (n = Math.max(n, l), i = Math.max(i, g), a[h] = new Array(l), p = 0; p < a[h].length; p++) a[h][p] = 255 & t.buffer[p + r];
            r += l;
            var f = u.getErrorCorrectPolynomial(g), c = new o(a[h], f.getLength() - 1).mod(f);
        ...
        var v = new Array(m), T = 0;
        for (p = 0; p < n; p++) for (h = 0; h < e.length; h++) p < a[h].length && (v[T++] = a[h][p]);
        for (p = 0; p < i; p++) for (h = 0; h < e.length; h++) p < s[h].length && (v[T++] = s[h][p]);
        return v;
    };
    for (var a = {
        MODE_NUMBER: 1,
        ...
        getErrorCorrectPolynomial: function(t) {
            for (var e = new o([ 1 ], 0), r = 0; r < t; r++) e = e.multiply(new o([ 1, l.gexp(r) ], 0));
            return e;
        },
    ...
    for (g = 8; g < 256; g++) l.EXP_TABLE[g] = l.EXP_TABLE[g - 4] ^ l.EXP_TABLE[g - 5] ^ l.EXP_TABLE[g - 6] ^ l.EXP_TABLE[g - 8];
    for (g = 0; g < 255; g++) l.LOG_TABLE[l.EXP_TABLE[g]] = g;
    o.prototype = {
        get: function(t) {
            return this.num[t];
        },
        ...
        multiply: function(t) {
            for (var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++) for (var n = 0; n < t.getLength(); n++) e[r + n] ^= l.gexp(l.glog(this.get(r)) + l.glog(t.get(n)));
            return new o(e, 0);
        },
        mod: function(t) {
    ...
    n.getRSBlocks = function(t, e) {
        ...
        for (var o = r.length / 3, i = [], a = 0; a < o; a++) for (var s = r[3 * a + 0], h = r[3 * a + 1], u = r[3 * a + 2], l = 0; l < s; l++) i.push(new n(h, u));
        return i;
    ...
    (t = function(t, e) {
        ...
        this._oQRCode = new r(function(t, e) {
            for (var r = 1, o = function(t) {
                var e = encodeURI(t).toString().replace(/\%[0-9a-fA-F]{2}/g, "a");
                return e.length + (e.length != t ? 3 : 0);
            }(t), n = 0, i = f.length; n <= i; n++) {
                var a = 0;
                switch (e) {
                  case s.L:
                    a = f[n][0];
            ...
            return r;
        }(t, this._htOption.correctLevel), this._htOption.correctLevel), this._oQRCode.addData(t), 
        this._oQRCode.make(), this.makeImage();
