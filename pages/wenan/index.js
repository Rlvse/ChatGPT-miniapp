!function() {
    ...
    var t, n = require("../../request/server.js"), i = function(e) {
        return e && e.__esModule ? e : {
            default: e
        };
    }(require("../../lib/runtime/runtime")), a = (require("../../utils/asyncWx.js"), 
    require("../../utils/base64")), r = require("../../utils/aesUtilsXm.js");
    Page((e(t = {
        data: {		
	...
	e(t, "bindStylePicker", function(e) {
	    console.log('bindStylePicker发送选择改变，携带值为', e.detail.value)
		this.setData({
	...
	e(t, "adClose", function() {
		...
		if(this.data.text == null || this.data.text.trim().length == 0){
			console.log("null");
			 wx.showToast({
			    title: "关键字不能为空",
			    icon: "error"
        ...
        return o(i.default.mark(function o() {
            ...
            return i.default.wrap(function(o) {
                for (;;) switch (o.prev = o.next) {
                  case 0:
                    (t = e).data.isImageDown || (t.updateImageDown(!0), n = e.data.videoObj.videoCover, 
                    r = "https://kejikk.com/image/down?path=" + a.encode(n), wx.getSetting({
                        success: function(e) {
                            wx.downloadFile({
                                url: r,
                                success: function(e) {
                                    if (e.dataLength > 0) {
                                        ...
                                        wx.saveImageToPhotosAlbum({
                                            filePath: o,
                                            success: function(e) {
                                                t.updateImageDown(!1), wx.showToast({
                                                    title: "保存成功",
                                                    icon: "success",
                                                    duration: 1500
                                                });
                                    ...
                                    } else t.updateImageDown(!1), wx.showToast({
                                        title: "保存失败",
                                        icon: "error",
                                        duration: 1500
                                    });
                                ...
                                t.updateImageProgress(e.progress);
                            });
                        },
                        fail: function(e) {
                            t.updateImageDown(!1), wx.showToast({
        ...
        return o(i.default.mark(function o() {
            ...
            return i.default.wrap(function(o) {
                for (;;) switch (o.prev = o.next) {
                  case 0:
                    (t = e).data.isVideoDown || (t.updateVideoDown(!0), n = e.data.videoInfo.videoUrl, 
                    console.log(n), r = "https://kejikk.com/video/down?path=" + a.encode(n), wx.getSetting({
                        success: function(e) {
                            wx.downloadFile({
                                url: r,
                                success: function(e) {
                                    if (e.dataLength > 0) {
                                        ...
                                        wx.saveVideoToPhotosAlbum({
                                            filePath: o,
                                            success: function(e) {
                                                t.updateVideoDown(!1), wx.showToast({
                                                    title: "保存成功",
                                                    icon: "success",
                                                    duration: 1500
                                                });
                                            ...
                                            fail: function(e) {
                                                console.log(e), t.updateVideoDown(!1), wx.showToast({
                                                    title: "保存失败",
                                                    icon: "error",
                                                    duration: 1500
                                                });
                                    ...
                                    } else t.updateVideoDown(!1), wx.showToast({
                                        title: "保存失败",
                                        icon: "error",
                                        duration: 1500
                                    });
                                ...
                                t.updateVideoProgress(e.progress);
                            });
                        },
                        fail: function(e) {
                            t.updateVideoDown(!1), wx.showToast({
